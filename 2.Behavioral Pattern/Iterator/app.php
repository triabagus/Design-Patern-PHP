...
$firstBook = new Book('PHP DESIGN PATTERN', 'TRIA');
$secondBook = new Book('GOLANG DESIGN PATTERN', 'BAGUS');
$thirdBook = new Book('NODE JS DESIGN PATTERN', 'NUR');
...
while($booksIterator->hasNextBook() ){
    ...
    writeln('dapatkan buku selanjutnya dengan iterator :');
    writeln($book->getAuthorAndTitle() );
    writeln('');
}

$book = $booksIterator->getCurrentBook();
writeln('mendapatkan buku terbaru dengan iterator:');
writeln($book->getAuthorAndTitle() );
writeln('');

writeln('Menguji Kebalikannya Iterator');
...
while ($booksReverseIterator->hasNextBook()) {
    ...
    writeln('dapatkan buku selanjutnya dengan kebalikan iterator :');
    writeln($book->getAuthorAndTitle());
    writeln('');
}

$book = $booksReverseIterator->getCurrentBook();
writeln('mendapatkan buku terbaru dengan kebalikan iterator :');
writeln($book->getAuthorAndTitle());
writeln('');
