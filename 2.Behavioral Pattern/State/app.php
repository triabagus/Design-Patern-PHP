...
class BookContext
{
    ...
    //bookList tidak dipakai pada waktu konstruk
...
$book = new Book('Design Pattern', 'Tria Bagus');
$context = new BookContext($book);

writeln('test 1 - tampilkan nama: ');
writeln($context->getBookTitle() );
writeln('');

writeln('test 2 - tampilkan nama:');
writeln($context->getBookTitle());
writeln('');

writeln('test 3 - tampilkan nama:');
writeln($context->getBookTitle());
writeln('');

writeln('test 4 - tampilkan nama:');
writeln($context->getBookTitle());
writeln('');
